 ...
 * @requires Web3
 * @throws {ULCDocAPI.DependancyError} if Web3 doesn't exist.
 * @throws {Error} if web3provider not given and web3 not injected by browser.
 */
function ULCDocAPI(_DefaultWeb3provider) {

    /**
     * @description get all available addresses on the browser
    ...
    * @return {String} serialized data */
    ...
    this.getNetwork = async function() {
        //if not yet cached, we call the Web3 object.
        if(whichNetwork === "") {
    ...
    */
    this.ULCDocKernel  = function (_KernelAddress) {
        ...
        if(typeof ULCDocVersionner_ABI === 'undefined'){
            throw new ULCDocAPI.DependancyError("ULCDocAPI needs ULCDocVersionner_ABI to work properly.");
        }
        ...
        */
        ...
        this.getPreviousKernel = async function() {
            ...
            try {
                previousAddress = await Kernel_Contract.methods.PREVIOUS_CONTRACT().call();
            }catch (e){
                throw new ULCDocAPI.BlockchainQueryError("Impossible to call \"PREVIOUS_CONTRACT\" parameter. Is contract address a valid kernel smart contract ?\
        ...
        */
        this.getNextKernel = async function() {
            ...
            try {
                nextAddress = await Kernel_Contract.methods.nextContract().call();
            }catch (e){
                throw new ULCDocAPI.BlockchainQueryError("Impossible to call \"nextContract\" parameter. Is contract address a valid kernel smart contract ?\
                Blockchain error : '" + e.message + "'");
            }
        ...
        */
        let getKernelConfigV5 = async function(){
            ...
            let values = await Promise.all(promList).catch(function(err){
                throw new ULCDocAPI.BlockchainQueryError("Impossible to fetch Kernel basic information V5.\
        ...
        */
        this.connect = async function () {
            ...
            try {
                ...
                throw new ULCDocAPI.BlockchainQueryError("Impossible to call \"CONTRACT_VERSION\" parameter. Is contract address a valid kernel smart contract ?\
                Blockchain error : '" + e.message + "'");
            }
            ...
            if(kernelVersion === 5){
                ...
                throw new Error("Impossible to configure Kernel_Contract. Internal error");
            }
        ...
        */
        this.canSign = async function(_Address) {
            ...
            try {
                ...
                throw new ULCDocAPI.BlockchainQueryError("Impossible to call \"owners\" parameter. Is contract address a valid kernel smart contract ?\
                Blockchain error : '" + e.message + "'");
            }
            ...
            if(!isOwner){
                try {
                    ...
                    throw new ULCDocAPI.BlockchainQueryError("Impossible to call \"operators\" parameter. Is contract address a valid kernel smart contract ?\
                Blockchain error : '" + e.message + "'");
                }
            ...
            */
            async function loadDocumentDataV5(){
                ...
                try {
                    ...
                    throw new ULCDocAPI.BlockchainQueryError("Impossible to call \"isInitialized\" parameter. Is contract address a valid kernel smart contract ?\
                Blockchain error : '" + e.message + "'");
                }
                ...
                if(document_obj.initialized){
                    ...
                    let firstSerie = await Promise.all(firstPromList).catch(function(err){
                        throw new ULCDocAPI.BlockchainQueryError("Impossible to fetch Document basic information V5.\
                Original error : '" + err.message + "'");
                    });
                    ...
                    if(document_obj.signed){
                        ...
                        let secSerie = await Promise.all(secPromList).catch(function(err){
                            throw new ULCDocAPI.BlockchainQueryError("Impossible to fetch Document basic information V5.\
                Original error : '" + err.message + "'");
                        });
                        ...
                        if(document_obj.revoked){
                            ...
                            let revokedDate;
                            try {
                                revokedDate = await Kernel_Contract.methods.getRevokedDate(_SignatureHash).call();
                            }catch (e){
                                throw new ULCDocAPI.BlockchainQueryError("Impossible to call \"getRevokedDate\" parameter. Is contract address a valid kernel smart contract ?\
                Blockchain error : '" + e.message + "'");
                            }
            ...
            */
            this.getConfirmList = async function(){
                ...
                try {
                    ...
                    throw new ULCDocAPI.BlockchainQueryError("Impossible to call \"getOperatorRequest\" parameter. Is contract address a valid kernel smart contract ?\
                Blockchain error : '" + e.message + "'");
                }
            };
    ...
    this.ULCDocModerator = function (_ModeratorAddress) {
         ...
         */
        let getModeratorConfigV4 = async function(){
            //lisibility purposes : creating an array
            let promList = [];
            ...
            //Executing Promise.All
            let values = await Promise.all(promList).catch(function(err){
                throw new ULCDocAPI.BlockchainQueryError("Impossible to fetch Moderator basic information V4.\
                Original error : '" + err.message + "'");
            });
        ...
        let getModeratorQueryV4 = async function(_kernelAddress) {
            ...
            let queryIdentity;
            try {
                queryIdentity = await Moderator_Contract.methods.getKernelIdentity(_kernelAddress).call();
            }catch (e){
                throw new ULCDocAPI.BlockchainQueryError("Impossible to call \"getKernelIdentity\" parameter. Is contract address a valid moderator smart contract ?\
                Blockchain error : '" + e.message + "'");
            }
            ...
            if(queryIdentity[0]){
                ...
                let queryInfo;
                try {
                    queryInfo = await Moderator_Contract.methods.getKernelInformation(_kernelAddress).call();
                }catch (e){
                    throw new ULCDocAPI.BlockchainQueryError("Impossible to call \"getKernelInformation\" parameter. Is contract address a valid moderator smart contract ?\
                Blockchain error : '" + e.message + "'");
                }
        ...
        this.connect = async function () {
            ...
            try {
                ...
                throw new ULCDocAPI.BlockchainQueryError("Impossible to call \"CONTRACT_VERSION\" parameter. Is contract address a valid moderator smart contract ?\
                Blockchain error : '" + e.message + "'");
            }
            ...
            if(moderatorVersion === 4){
                ...
                Moderator_Info = await getModeratorConfigV4();
            }
            else {
...
/**
 * @description Error object when a query to blockchain has throw an error.
 * @param message
 */
ULCDocAPI.BlockchainQueryError = function(message){
    this.constructor.prototype.__proto__ = Error.prototype;
    this.name = this.constructor.name;
    this.message = message;
};
